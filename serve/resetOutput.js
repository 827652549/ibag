...
fs.mkdirSync("../output");
  ...
  //todo!!!：重置"instructions/_haveExeced"为[]
  fs.writeFileSync('../instructions/_haveExeced.json',JSON.stringify([]),'utf8')
  ...
  fs.writeFileSync('../configs/global.json',JSON.stringify(globalConfig),'utf8')
  ...
  run(globalConfig,function () {
    ...
    //初始化global.json为默认配置
    fs.writeFileSync('../configs/global.json',JSON.stringify(globalConfigInit),'utf8')
  })
