...
const createFile = ["tests",["unit",{"filename":"example","extension":"spec.js","context":"describe('computation', () => {\n  it('1+1=?', () => {\n    expect(1+1).toBe(2)\n  })\n})\n"}]]
/**
 * 指令【为vue导入jest】
 */
  ...
  constructor (props) {
    ...
    this.run(function () {
      ...
      addItemInPackageJson(
        'devDependencies',
        {
          "@vue/cli-plugin-unit-jest": npmPackageVersion["@vue/cli-plugin-unit-jest"],
