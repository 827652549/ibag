...
function ChangeFileABC (component) {
  //需要添加A、B、C的store目录
  const addDirStore =["store",{"filename":"actionCreators","extension":"js","context":"import * as constants from './constants';\n\n//action1\nexport const changeNum1 = (num) => ({\n    type: constants.CHANGE_NUM_1,\n    num1:num\n});\n\n//action2\nexport const changeNum2 = (num) => ({\n  type: constants.CHANGE_NUM_2,\n  num2:num\n});\n\n"},{"filename":"constants","extension":"js","context":"export const CHANGE_NUM_1 = Symbol()\nexport const CHANGE_NUM_2 = Symbol()\n"},{"filename":"index","extension":"js","context":"import reducer from './reducer';\nimport * as constants from './constants';\nimport * as actionCreators from './actionCreators'\n\nexport {reducer,constants,actionCreators};"},{"filename":"reducer","extension":"js","context":"import * as constants from './constants'\nconst defaultState = {\n  num1: 0,\n  num2: 0,\n}\n\nconst reducer = (state = defaultState, action) => {\n  let newState = state\n  switch (action.type) {\n    case constants.CHANGE_NUM_1:\n      newState.num1 = action.num1\n      break\n    case constants.CHANGE_NUM_2:\n      newState.num2 = action.num2\n      break\n    default:\n      return state\n  }\n  return newState\n}\nexport default reducer\n"}]
