...
const createFile = ["tests",["unit",{"filename":"example","extension":"spec.js","context":"import { expect } from 'chai'\ndescribe('computation', () => {\n  it('1+1=?', () => {\n    expect(1+1).to.be.a('number',2)\n  })\n})\n"}]]
/**
 * 指令【为vue导入mocha】
 */
  ...
  constructor (props) {
    ...
    this.run(function () {
      ...
      addItemInPackageJson(
        'devDependencies',
        {
          "@vue/cli-plugin-unit-mocha": npmPackageVersion["@vue/cli-plugin-unit-mocha"],
