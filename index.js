...
const argv = require("yargs")
  ...
  .command(
    "init",
    "Run serve and open a web page for configuration",
    function (yargs) {
      ...
      console.log(
        "You can now view the web page for configuration in the browser."
      );
    }
  )
  .command(
    "lst [isLst]",
    "Do all dependencies use the latest stable version?",
    function (yargs) {
      ...
      console.log(
        "All dependencies will be the latest stable version?",
        yargs.argv._[1]
      );
    }
  )
...
|_| |_.__/   \\__,_|  \\__, |
  ...
  .usage(
    "Welcome to ibag, a visual, fast, and customizable front-end scaffolding!"
  )
  .help("h")
  .alias("h", "help")
  .alias("v", "version")
